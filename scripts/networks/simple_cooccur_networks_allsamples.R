...
metaG_simple_NULL <- simple_cooccur_parallel(in_df = metaG_presence,
                                             ncores = 64,
                                             tmp_dir = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_allsamples/metaG_simple_cooccur_tmp/",
                                             output_tab = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_allsamples/metaG_simple_cooccur.allsamples.tsv")
