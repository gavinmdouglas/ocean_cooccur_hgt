...
write.table(x = metaG_rpkm_netcomi$edgelist1,
            file = "/mfs/gdouglas/projects/water_mags/coverm/network_working/metaG_spieceasi_rpkm.tsv",
            sep = "\t",
            quote = FALSE,
            col.names = TRUE,
            row.names = FALSE)
...
write.table(x = metaT_rpkm_netcomi$edgelist1,
            file = "/mfs/gdouglas/projects/water_mags/coverm/network_working/metaT_spieceasi_rpkm.tsv",
            sep = "\t",
            quote = FALSE,
            col.names = TRUE,
            row.names = FALSE)
