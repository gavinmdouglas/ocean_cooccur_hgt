...
metaG_simple_NULL <- hyperg_cooccur_parallel(in_df = metaG_presence,
                                             output_tab = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working/metaG_hyperg_cooccur.tsv",
                                             num_cores = 64)

metaT_simple_NULL <- hyperg_cooccur_parallel(in_df = metaT_presence,
                                             output_tab = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working/metaT_hyperg_cooccur.tsv",
                                             num_cores = 64)
