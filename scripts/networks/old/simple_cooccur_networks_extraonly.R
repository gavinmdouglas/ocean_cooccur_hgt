...
metaG_presence <- read.table(file = "/mfs/gdouglas/projects/ocean_mags/coverm/combined_tables/metaG_presence_extraonly.tsv.gz",
                             header = TRUE, sep = "\t", row.names = 1, stringsAsFactors = FALSE)

metaG_simple_NULL <- simple_cooccur_parallel(in_df = metaG_presence,
                                             ncores = 64,
                                             tmp_dir = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_extraonly/metaG_simple_cooccur_tmp/",
                                             output_tab = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_extraonly/metaG_simple_cooccur.extraonly.tsv")
r
