...
hyperg_w_lower <- read_corr_info(pairwise_file = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_extraonly/corr_out/metaG_hyperG.w_lower.pairwise.tsv",
                                 partial_file = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_extraonly/corr_out/metaG_hyperG.w_lower.partial.tsv",
                                 in_title = "Hypergeometric (with strains and species)")

hyperg_wo_lower <- read_corr_info(pairwise_file = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_extraonly/corr_out/metaG_hyperG.pairwise.tsv",
...
simple_w_lower <- read_corr_info(pairwise_file = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_extraonly/corr_out/metaG_simple.w_lower.pairwise.tsv",
                                 partial_file = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_extraonly/corr_out/metaG_simple.w_lower.partial.tsv",
                                 in_title = "Simple co-occur (with strains and species)")

simple_wo_lower <- read_corr_info(pairwise_file = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_extraonly/corr_out/metaG_simple.pairwise.tsv",
...
propr_w_lower <- read_corr_info(pairwise_file = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_extraonly/corr_out/metaG_propr.w_lower.pairwise.tsv",
                                 partial_file = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_extraonly/corr_out/metaG_propr.w_lower.partial.tsv",
                                 in_title = "propr co-abun. (with strains and species)")

propr_wo_lower <- read_corr_info(pairwise_file = "/mfs/gdouglas/projects/ocean_mags/coverm/network_working_extraonly/corr_out/metaG_propr.pairwise.tsv",
...
tmp <- read.table("projects/ocean_mags/coverm/combined_tables/metaG_presence_extraonly.tsv.gz",
