...
allsamples_presence <- read.table(file = "/mfs/gdouglas/projects/ocean_mags/progenomes_analyses/networks/combined_tables/metaG_presence_allsamples.tsv.gz",
...
mean_gzfile_connection <-  gzfile("/mfs/gdouglas/projects/ocean_mags/progenomes_analyses/networks/combined_tables//allsamples_present_metadata_mean_by_sample.tsv.gz", "w")
...
median_gzfile_connection <-  gzfile("/mfs/gdouglas/projects/ocean_mags/progenomes_analyses/networks/combined_tables//allsamples_present_metadata_median_by_sample.tsv.gz", "w")
