...
classify_genomes_filt_cutoff(freeliving_samples = freeliving_map$sample_name,
                             ...
                             presence_filepath = '~/projects/ocean_mags/progenomes_analyses/networks/combined_tables/metaG_presence_allsamples.tsv.gz',
                             rpkm_filepath = '~/projects/ocean_mags/progenomes_analyses/networks/combined_tables/metaG_rpkm_allsamples.tsv.gz',
                             freeliv_outfile = '/mfs/gdouglas/projects/ocean_hgt_zenodo/taxa_subsets/progenomes_freeliving_associated.tsv',
                             lessfilt_outfile = '/mfs/gdouglas/projects/ocean_hgt_zenodo/taxa_subsets/progenomes_lessfiltered_associated.tsv',
                             num_cores=64)
