...
mean_gzfile_connection <-  gzfile("/mfs/gdouglas/projects/ocean_mags/networks/combined_tables/geotraces_present_metadata_mean_by_sample.tsv.gz", "w")
...
median_gzfile_connection <-  gzfile("/mfs/gdouglas/projects/ocean_mags/networks/combined_tables/geotraces_present_metadata_median_by_sample.tsv.gz", "w")
