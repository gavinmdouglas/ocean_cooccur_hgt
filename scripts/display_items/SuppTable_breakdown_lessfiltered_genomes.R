...
write.table(x = lessfilt_hgt_taxonomy, file = '/mfs/gdouglas/projects/ocean_hgt_zenodo/lessfiltered_taxa_hgt/hyperg_clusterbased_lessfilt_hgt_taxonomy.tsv',
            col.names = NA, row.names = TRUE, sep = '\t', quote = FALSE)

write.table(x = prepped_lessfilt_hgt_subset, file = '/mfs/gdouglas/projects/ocean_hgt_zenodo/lessfiltered_taxa_hgt/hyperg_clusterbased_lessfilt_hgt_prepped_input.tsv',
